...
public class DataLoaderListener implements ApplicationContextListener {
  ...
  public void contextInitialized(Map<String,Object> context) {
    ...
    try {
      ...
      context.put("memberDao", new MemberDao(sqlSessionFactory));
      context.put("boardDao", new BoardDao(sqlSessionFactory));
      context.put("photoBoardDao", new PhotoBoardDao(sqlSessionFactory));
      context.put("photoFileDao", new PhotoFileDao(sqlSessionFactory));
