...
public class PhotoBoardHandler {
  ...
  public void add(BufferedReader in, PrintWriter out) throws Exception {
    try {
  ...
  public void delete(BufferedReader in, PrintWriter out) throws Exception {
    try {
      out.print("번호?\n!{}!\n"); out.flush();
  ...
  public void update(BufferedReader in, PrintWriter out) throws Exception {
    try {
      out.print("번호?\n!{}!\n"); out.flush();
      int no = Integer.parseInt(in.readLine());
